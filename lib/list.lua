...
-- by GuitarMusashi616
-- https://github.com/GuitarMusashi616

-- modified by CaptainSpaceCat
-- https://github.com/CaptainSpaceCat
...
function List:__init(iter_tbl_or_item, ...)
  ...
  if type(iter_tbl_or_item) == "function" then
    ...
    self.list = list
  elseif type(iter_tbl_or_item) == "table" then
    for _, v in pairs(iter_tbl_or_item) do
      table.insert(list, v)
    end
    self.list = list
  else
